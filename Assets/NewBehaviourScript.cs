...
public class NewBehaviourScript : MonoBehaviour
{
       ...
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=41.85&lon=-87.65&APPID=061b5867f4d7b4e8c6b6b9e13b3e0ae2&units=imperial";
    ...
    IEnumerator GetRequest(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
                ...
                int easyTempC = Mathf.RoundToInt((float)(easyTempF - 32) * 5/9);
